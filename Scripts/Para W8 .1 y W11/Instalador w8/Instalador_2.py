...
class InstallerApp(tk.Tk):
    def __init__(self):
        ...
        self.background_image = tk.PhotoImage(file="C:\\Instalador w8\\Fondo.png")
        ...
        self.commands = [
            ...
            ("Framework", self.silent_install_command('"C:\\Win_Apps\\Framework.exe"', '/PASSIVE')),
            ...
            ("ServidorKMS", '"C:\\Win_Apps\\W8.1_Pro"'),
            ("Chrome", '"C:\\Win_Apps\\Chrome.exe"'),
            ("Chrome", '"C:\\Win_Apps\\MicrosoftEdgeSetup.exe"'),
    ...
    def run_next_command(self):
        if self.current_command < len(self.commands):
            ...
            self.after(3000, self.run_next_command) 
        else:
